...
public class ItemKeyframeAnimations {
    ...
    public static void animate(AnimatedItemModel<?> model, AnimationDefinition animationDefinition, long accumulatedTime, float scale, Vector3f animationVecCache) {
