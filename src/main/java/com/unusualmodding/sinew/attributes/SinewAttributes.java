package com.unusualmodding.sinew.attributes;
...
public class SinewAttributes {
    ...
    public static final DeferredRegister<Attribute> ATTRIBUTES = DeferredRegister.create(ForgeRegistries.ATTRIBUTES, Sinew.MODID);
    ...
    public static RegistryObject<Attribute> registerAttribute(String name, Function<String, Attribute> attribute) {
        return ATTRIBUTES.register(name, () -> attribute.apply("attribute.name." + Sinew.MODID + "." + name));
    }
}
