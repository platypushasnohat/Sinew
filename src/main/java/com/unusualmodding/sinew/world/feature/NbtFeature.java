package com.unusualmodding.sinew.world.feature;

import com.mojang.logging.LogUtils;
import com.mojang.serialization.Codec;
import com.unusualmodding.sinew.mixins.StructureTemplateAccessor;
import com.unusualmodding.sinew.utils.GeneralUtils;
...
public class NbtFeature<T extends NbtFeatureConfig> extends Feature<T> {
    ...
    public boolean place(FeaturePlaceContext<T> context) {
        ...
        List<StructureTemplate.StructureBlockInfo> list = placementsettings.getRandomPalette(((StructureTemplateAccessor) template.get()).sinew$getBlocks(), mutable).blocks();
