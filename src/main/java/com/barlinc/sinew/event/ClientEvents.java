...
import com.barlinc.sinew.heart_type.HeartTypeRegistry;
import com.barlinc.sinew.heart_type.SinewHeartType;
...
@Mod.EventBusSubscriber(modid = Sinew.MOD_ID, value = Dist.CLIENT,bus = Mod.EventBusSubscriber.Bus.FORGE)
