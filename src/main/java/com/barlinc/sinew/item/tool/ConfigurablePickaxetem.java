...
public class ConfigurablePickaxetem extends PickaxeItem {

    private final UUID TOOL_MODIFIER_UUID = UUID.fromString("c5d7e1bc-f006-4793-b517-6475b5586191");
    private final ToolDefinition definition;
    private Multimap<Attribute, AttributeModifier> attributes;

    public ConfigurablePickaxetem(ToolDefinition toolDefinition, int attackDamageModifier, float attackSpeedModifier, Properties properties) {
