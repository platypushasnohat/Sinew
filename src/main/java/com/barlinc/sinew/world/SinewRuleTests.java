...
import com.barlinc.sinew.world.structure.rule_test.*;
...
public class SinewRuleTests {
    public static final DeferredRegister<RuleTestType<?>> RULE_TESTS = DeferredRegister.create(Registries.RULE_TEST, Sinew.MOD_ID);
